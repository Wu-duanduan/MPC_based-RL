...
# torch.save(agent.q_net.state_dict(), 'DQN-MPC.pth')
...
# savemat('DQN_MPC11.mat', {'episodes_list': episodes_list, 'mv_return': mv_return, 's_loss': s_loss_list, 'r_loss': r_loss_list})
