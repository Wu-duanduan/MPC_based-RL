...
torch.save(agent.q_net.state_dict(), 'DQN.pth')
...
# savemat('DQN.mat', {'episodes_list': episodes_list, 'return_list': return_list, 'mv_return': mv_return})
np.save('episodes.npy', episodes_list)
np.save('mv_return03.npy', mv_return)
