...
if __name__ == "__main__":
    ...
    for episode in range(MAX_EPISODE):
        ...
        for j in range(MAX_STEP):
            ...
            qBefore = q
            q = qNext
        testReward = test(dynamicController.ac.pi,conf)
        testReward_list.append(testReward)
        print('Episode:', episode, 'Reward1:%2f' % testReward,
    ...
    np.save('mv_return04.npy', testReward_list)
    # 绘制
