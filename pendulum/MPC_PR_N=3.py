...
class DDPG:
    ...
    def update(self, transition_dict):
        ...
        r2_values = torch.reshape(self.sr_net(s2_values, a2_values)[:, 3], [batch_size, 1])  # R+1值
...
# savemat('DDPG_MPC4.mat', {'episodes_list': episodes_list, 'return_list': return_list, 'mv_return': mv_return, 'sr_loss': sr_loss_list})
np.save('mv_return41.npy', mv_return)
np.save('sr_loss41.npy', sr_loss_list)
