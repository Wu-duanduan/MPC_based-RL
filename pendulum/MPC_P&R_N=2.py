...
# savemat('DDPG_MPC1.mat', {'episodes_list': episodes_list, 'return_list': return_list, 'mv_return': mv_return, 's_loss': s_loss_list, 'r_loss': r_loss_list})
np.save('mv_return11.npy', mv_return)
np.save('s_loss11.npy', s_loss_list)
np.save('r_loss11.npy', r_loss_list)
